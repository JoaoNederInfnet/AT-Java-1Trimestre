...
public class MetodosValidacao
{
    ...
    //----------------------------------//--------------------------------
    //b)Validando se é um valor de empréstimo válido
    public static ResultadoValidacao validarEmprestimo(String emprestimo)
    {
        //1)Validações
        //a)Validando se a entrada está vazia
        ...
        String entrada = emprestimo.replace("," , ".");
        ...
        //----------------------------------//--------------------------------
        //c)Validando se o empréstimo é maior que zero
        if(valorEmprestimo <= 0)
        {
            return new ResultadoValidacao(false,"O valor inserido não é válido!");
        }
        //----------------------------------------------------------------------------

        //2)Retorno para empréstimo válido
        return  new ResultadoValidacao(true,"");
    }
    //----------------------------------//--------------------------------
    //b)Validando se é um valor de empréstimo válido
    public static ResultadoValidacao validarParcelas(String parcelas)
    {
        //1)Validações
        //a)Validando se a entrada está vazia
        if(parcelas.isEmpty())
        ...
        //b)Validando se é um número
        //Para o usuário conseguir inserir valores com vírgula
        String entrada = parcelas.replace("," , ".");
        ...
        try
        {
            valorParcelas = Integer.parseInt(entrada);
        }
        //Disparando erro
        catch (NumberFormatException e)
        {
        ...
        //----------------------------------//--------------------------------
        //c)Validando se o empréstimo é um número de 6 a 48
        if(valorParcelas < 6 && valorParcelas > 48)
        {
            return new ResultadoValidacao(false,"O valor inserido não é um número de 6 a 48!");
        }
        //----------------------------------------------------------------------------
